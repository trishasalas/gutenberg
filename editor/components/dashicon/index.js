...
export default class Dashicon extends wp.element.Component {
	...
	render() {
		...
		return (
			<svg aria-hidden="true" className={ iconClass } xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
